 ...
 * @create 2020/05/24 18:04:24
 *
 * Java8Converter/Java8Converter.main/WrappedClassImplements.java
 */
...
//        System.out.println(ser);
    ...
    private static UnsupportedOperationException createMethodWrapper$error(
        ...
        return new UnsupportedOperationException(
                "Types not match. " + target_method_desc + " -> " +
                        interface_method_desc + (reason == null ? "" : " Caused by " + reason));
    }
